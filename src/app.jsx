...
// ClickUp brand-inspired palette (sources: brand pages)
const colors = {
  primary: "#7B68EE", // Cornflower-ish purple
  hotPink: "#FD71AF",
  sky: "#49CCF9",
  yellow: "#FFC800",
  ink: "#292D34",
...
function useCountdown(target: DateTime) {
  ...
  return useMemo(() => {
    let diff = target.diff(now, ["days", "hours", "minutes", "seconds"]).shiftTo(
      "days",
      "hours",
      "minutes",
      "seconds"
...
export default function App() {
  // IMPORTANT: Targets are specified in America/Los_Angeles to honor "PT" exactly
  ...
  useEffect(() => {
    // Set CSS custom props so we can reference brand colors inline with Tailwind
